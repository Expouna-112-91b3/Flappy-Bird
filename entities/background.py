...
class Background:
    ...
    def draw(self):
        ...
        # quantidade de grounds conectados eh igual a
        # tamanho da tela / 312 (largura do ground em pixels - a sobreposicao entre eles)
        # arredondado para cima
        loop_size = 0
        for _ in range(math.ceil(self.screen_width / 312) * 2):
            self.ground_movement_x -= .5
            self.screen.blit(self.ground_sprite, (loop_size + self.ground_movement_x, self.ground_x))
